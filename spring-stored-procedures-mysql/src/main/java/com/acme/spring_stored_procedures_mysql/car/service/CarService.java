package com.acme.spring_stored_procedures_mysql.car.service;

import com.acme.spring_stored_procedures_mysql.car.controller.Car;
...
public class CarService {
   ...
   public int getTotalCarsByModelSelect(String model) {
      return carRepository.getTotalCarsByModelSelect(model);
   }
}
